...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'mianshakir9@hotmail.com',
    href: 'mailto:mianshakir9@hotmail.com',
  },
  {
    icon: Phone,
    label: 'Phone',
    value: '+92 300 8118963',
    href: 'tel:+923008118963',
  },
  {
    icon: MapPin,
    label: 'Location',
      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {contactInfo.map((info) => (
                <a
                  key={info.label}
                  href={info.href}
                  className="flex items-center gap-4 p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 group"
                >
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/shakirjamil9"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/shakirjamil9/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-blue-900/20 rounded-full transition-colors duration-200"
                >
          ...
          >
            ...
            {isSubmitted && (
              <div className="mb-6 p-4 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200"
              >
                {isSubmitting ? (
                  <>
